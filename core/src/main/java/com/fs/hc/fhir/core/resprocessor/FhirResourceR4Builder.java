...
public class FhirResourceR4Builder extends AbstractFhirResourceBuilder {
    public FhirResourceR4Builder(FhirContext fhirContext, FhirValidator fhirValidator, HashMap<String, HashMap<String, List<String>>> compartmentDefinitionMap, Properties defaultProfileProperties) {
